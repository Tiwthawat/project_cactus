...
export default function AdminUsersPage() {
  ...
  for (const u of users) {
    ...
    else user += 1; // ที่เหลือถือว่า user
  }
  ...
  [
    ...
    { v: 'user', label: '✅ ผู้ใช้ปกติ', active: 'from-green-500 to-green-600' },
    { v: 'banned', label: '🚫 ถูกแบน', active: 'from-red-500 to-red-600' },
  ] as const
).map((x) => {
  const isActive = statusFilter === x.v;
  ...
  const activeCls = `bg-gradient-to-r ${x.active} text-white border-transparent`;
